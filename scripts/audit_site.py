...
#     （2026-08-16・台帳#377）。いま新台タスクも更新タスクも停止中なので、
#     名簿に無い先へ実際に通信することは起きていない。
#     ★ただしタスクを再開する条件★＝再開前にここが0件であること
#     （名簿に無い先は、再開した瞬間に到達する）。
#     ★配信を止めない★＝ここで止めると、記事とは無関係な理由で
#     サイトの配信ごと落ちる（2026-08-12に項目31で実際に起きた）。
