...
ALLOW_BASENAMES = {
    ...
    # ★2AIが読んで決めた「読めなかったページ」の控え★（2026-09-21・台帳#701）
    #   機械が読めなかったページについて、ClaudeとCodexが生HTMLを読んで
    #   出した結論（使う／使わない／この箱は無くてよい）。
    #   失うと同じ突き合わせをやり直すことになる（Codexの回数も消費する）。
    #   中身は公開サイトのURLと逐語引用と指紋だけで、認証情報を含まない。
    "uchidokoro_page_reading.json",
    # ★2AIが「狙い目の線を引かない」と決めた控え★（2026-09-21・台帳#704）
    #   失うと、その機種について毎朝おなじ問いが出直す。
    #   中身は機種名と理由だけで、認証情報を含まない。
    "uchidokoro_checker_no_line.json",
