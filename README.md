...
- `assets/data/machine-details/` 機種別記事データ（JSON・全64機種）
...
- いざ！番長・Lアクダマドライブ・L虚構推理・真打 吉宗・A-SLOT+ 異世界かるてっとBT・LBトリプルクラウンセブン・レヴュースタァライト・ミスタージャグラー・L無職転生はポチポチくん非対応（小役確率が未解析）
...
- 全64機種の記事データJSON・チェッカー・ポチポチくん完成済み（うち6機種は2026年4月6日導入予定の新台・解析待ち）
- 交換率4パターン対応済み（Aタイプ除く）
