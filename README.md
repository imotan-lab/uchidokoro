...
- `assets/data/machine-details/` 機種別記事データ（JSON・全58機種）
...
### スマスロ・AT機（37機種）
北斗の拳 / 北斗転生2 / カバネリ / モンキーターンV / 攻殻機動隊 / 東京喰種 / 鉄拳6 / 番長4 / ヴァルヴレイヴ2 / かぐや様 / バイオハザードRE2 / チバリヨ2 / ダンベル何キロ持てる / ゴッドイーター / ゴブリンスレイヤー / バキ / 転スラ / 炎炎ノ消防隊2 / からくりサーカス / 東京リベンジャーズ / 新鬼武者3 / 化物語 / マギアレコード / 沖ドキ！ゴージャス / いざ！番長 / スーパーブラックジャック / 吉宗 / アズールレーン / モンスターハンターライズ / 戦国乙女4 / ソードアート・オンライン / Lバンドリ！ / L範馬刃牙 / スマスロヨルムンガンド / Lアクダマドライブ / L虚構推理 / 真打 吉宗
...
- いざ！番長・Lアクダマドライブ・L虚構推理・真打 吉宗・A-SLOT+ 異世界かるてっとBT・LBトリプルクラウンセブンはポチポチくん非対応（小役確率が未解析）
- スマスロヨルムンガンドはポチポチくん非対応（小役による設定差なし）
...
- 全58機種の記事データJSON・チェッカー・ポチポチくん完成済み（うち6機種は2026年4月6日導入予定の新台・解析待ち）
- 交換率4パターン対応済み（Aタイプ除く）
